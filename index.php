...
<html>
<head>
  <title>Mohammad Sayem Chowdhry</title>
...
<body>
<div class="container">
    <h2>Mohammad Sayem Chowdhury's Resume Registry</h2>
    ...
    <ul>
        ...
        echo '</li></ul>';
        ?>
        <p><a href="add.php" class="btn btn-primary" type="submit">Add New Entry</a></p>
        <p>
